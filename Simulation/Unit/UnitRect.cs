...
{
    /// <summary>
    /// Base class representing a rectangular simulation unit with a unique ID, model type, and operational state.
    /// Provides core functionality such as state toggling and integration with logging and MQTT messaging.
    /// </summary>
    internal class UnitRect(string id, Model model, Vector2 position, Vector2 dimension) : RectBody (position, dimension)
    {
        /// <summary>
